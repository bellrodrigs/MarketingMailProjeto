   ...
   String gp;
    ...
    public void geradorPdf() {
        ...
        try {                                                   //home/lab03/Documentos/
            ...
            doc.add(new Paragraph("Dados dos Contatos", FontFactory.getFont(
            ...
            PdfPCell cabeçalho = new PdfPCell(new Paragraph("Lista de Contatos"));
            cabeçalho.setHorizontalAlignment(Element.ALIGN_CENTER);
            cabeçalho.setColspan(3);
            ...
            while (rs.next()) {
                tabela.addCell(rs.getString("contato.nome"));
                tabela.addCell(rs.getString("contato.email"));
                tabela.addCell(rs.getString("grupo.nome"));
