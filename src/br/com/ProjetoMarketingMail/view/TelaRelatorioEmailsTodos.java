 ...
 */
public class TelaRelatorioEmailsTodos extends javax.swing.JFrame {
    
    
    private final Connection conexao;

    public TelaRelatorioEmailsTodos() {
        initComponents();
   ...
   String gp;
        ...
        try {                                                   //home/lab03/Documentos/
            ...
            PdfPCell cabeçalho = new PdfPCell(new Paragraph("Todos os E-mails enviados"));
    ...
    private void initComponents() {
        ...
        jButton5.setBounds(490, 420, 80, 30);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        TelaRelatorioEmailsTodos.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRelatorioEmailsTodos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaRelatorioEmailsTodos().setVisible(true);
            }
        });
    }
